...
import { Send, Mic, MicOff, Paperclip, Upload, FileText, Paintbrush, X } from 'lucide-react';
...
const ChatInput: React.FC<ChatInputProps> = ({ 
  ...
  const calculateMaxHeight = () => {
    ...
    const footerHeight = 120; // Approximate footer height including padding
    const topOffset = 200; // Space from top
  ...
  //Enhanced file upload handlers with actual functionality
  ...
  const attachmentMenuItems = [
    {
      icon: <Upload className="w-4 h-4 opacity-70" />,
      label: 'Upload files',
    ...
    {
      icon: (
        <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24" className="opacity-70">
    ...
    <div className="flex flex-col items-center w-full gap-1 p-2">
            ...
            <div className="flex flex-col gap-4 m-4 sm:m-6">
              ...
              <div className="flex gap-3 w-full items-center">
                ...
                <div style={{ opacity: 1, transform: 'none' }}>
                  ...
                  >
                    {isLoading ? (
                      <div className="w-5 h-5 animate-spin rounded-full border-2 border-gray-400 border-t-current"></div>
                    ) : hasText ? (
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 256 256">
      ...
      <div className="w-full max-w-4xl mt-3">
        <p className="text-xs text-yellow-400 text-center">
          Swiss Agent can make mistakes. Please double-check with official bank documents.
        </p>
      </div>
